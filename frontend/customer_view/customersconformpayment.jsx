...
useEffect(() => {
  ...
  const handleConfirm = async () => {
    ...
    try {
      const api = (await import('../src/utils/api/axiosConfig')).default;
      ...
      setTimeout(() => navigate(`/customers/payment/${loanId}/emi`), 1200);
    } catch (err) {
...
export default CustomersConfirmPayment;
